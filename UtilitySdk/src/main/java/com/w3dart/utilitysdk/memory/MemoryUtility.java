package com.w3dart.utilitysdk.memory;
...
//        Log.e(tag, " maxMemory: " + bytesToHuman(Runtime.getRuntime().maxMemory()));
    ...
    public static synchronized String getDetail() {
        return "Memory { \"total_ram\" : \"" + bytesToHuman(totalMemory) + "\"" +
                " , " + " \"available_ram\" : \"" + bytesToHuman(availMemory) + "\"" +
                " , " + " \"internal_memory\" : \"" + bytesToHuman(internalMemory) + "\"" +
                "}";
    }
