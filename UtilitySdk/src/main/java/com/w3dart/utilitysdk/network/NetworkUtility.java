package com.w3dart.utilitysdk.network;
...
//            Log.e(tag, "getIpAddress: " + getIPAddress(true));
    ...
    public static synchronized String getDetail() {
        return "NetworkDetails { \"is_network_available\" : \"" + isNetworkAvailable + "\"" +
                " , " + " \"is_wifi_enable\" : \"" + isWifiEnable + "\"" +
                " , " + " \"isMobileNetworkAvailable\" : \"" + isMobileNetworkAvailable + "\"" +
                "}";
    }
